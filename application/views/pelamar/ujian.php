...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <span class="badge badge-primary"><h3><?php echo $current ?></h3></span>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        $tl = $ujian_prop->akhir - strtotime(date("d-m-Y H:i:s"));
         ?>
        <li class="nav-item">
          <div class="nav-link" role="button"><i
              class="fas fa-clock"></i>&nbsp;<span id="time-left"><?php echo round($tl/60,0) ?></span> Menit
            </div>
        </li>
...
<!-- Bootstrap 4 -->
  ...
  <script type="text/javascript">
    $(function(){
      var timeleft = parseInt($("#time-left").text()), sec = <?php echo(min(59, $tl)); ?>;
      ...
      function ForceClose(timeout=true){
        if (timeout) {alert("Waktu Ujian Telah Berakhir");};
        unhook();
        isValid=false;
      ...
      $("input").on("click", function(){
        if (isValid) {
          var ids = <?php echo $soal_data->id ?>, v = $(this).val();
          $.post("pelamar/Ujian/ajaxReq", { id: ids, jawaban: v })
           .done(function( data ) {
              if(data=="success"){
