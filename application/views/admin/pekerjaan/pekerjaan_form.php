        <form action="<?php echo $action; ?>" method="post">
                ...
                <div id="berkas-container">
                    ...
                    <?php foreach ($data_berkas as $key => $berkas) : ?>
                        <div class="form-group berkas-fieldset">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <input type="hidden" class="form-control" name="id_berkas[]" value="<?php echo $berkas->id ?>" />
            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4"><label for="varchar">Ujian</label></div>
                    <div class="col-lg-5 col-md-5 col-sm-5"><label for="varchar">Jadwal</label></div>
                    <div class="col-lg-2 col-md-2 col-sm-2"><label for="varchar">Nilai Standar</label></div>
                ...
                <div id="ujian-container">
                        ...
                        <div class="form-group ujian-fieldset">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <input type="hidden" class="form-control" name="id_ujian[]" value="0" />
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="text" class="form-control" name="nilai_ujian[]" placeholder="Nilai Standar" value="" max="100" min="1" required="true" />
                                </div>
                    ...
                    <?php foreach ($data_ujian as $key => $ujian) : ?>
                        <div class="form-group ujian-fieldset">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <input type="hidden" class="form-control" name="id_ujian[]" value="<?php echo $ujian->id ?>" />
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <input type="text" class="form-control" name="nilai_ujian[]" placeholder="Nilai Standar" value="<?php echo $ujian->standar_nilai ?>" max="100" min="1" required="true" />
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1"><button type="button" onclick="return subjadwal(this)" class="btn btn-danger btn-md sub-jadwal-ujian"><i class="fa fa-minus"></i></button></div>
                            </div>
                        </div>
